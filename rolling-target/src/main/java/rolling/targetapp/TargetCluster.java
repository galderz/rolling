...
public class TargetCluster {
   ...
   static final String CONNECTION_STRING = "jmx://localhost:2626/Source-CacheManager-1/___defaultcache";
   ...
   public static void main(String[] args) throws Exception {
      ...
      // Connect via CLI and record known key set
      recordKnownKeySet();
   ...
   private static void recordKnownKeySet() throws Exception {
      ...
      Connection connection = ConnectionFactory.getConnection(CONNECTION_STRING);
   ...
   static EmbeddedCacheManager createCacheManager() {
      ConfigurationBuilder builder = new ConfigurationBuilder();
      builder.clustering().cacheMode(CacheMode.REPL_SYNC);
      builder.persistence().addStore(CLInterfaceLoaderConfigurationBuilder.class).connectionString(CONNECTION_STRING);
